function [out] = cubic2equi(headmove_h, top, bottom, left, right, front, back)
%from https://github.com/rayryeng/cubic2equi/blob/master/cubic2equi.m
...
headmove_h = headmove_h/360*width;
[X, Y] = meshgrid(1-headmove_h:width-headmove_h, 1:height);
%[X, Y] = meshgrid(1-headmove_h:width-headmove_h, 1-headmove_v:height-headmove_v);
